...
![Vite](https://img.shields.io/badge/Vite-8.1.4-646CFF?logo=vite&logoColor=white)
...
- **Teaching History** — 43 entries across 5 years (2022–2026), org type filter (4 categories)
...
- **Tests** — Vitest (1228 tests) + Django unittest (355 tests) + Playwright E2E (5 profiles)
