...
### 2025.08.29 - 성능 모니터링 개선 및 PWA 기능 강화

#### ✅ 개선 사항

- **INP (Interaction to Next Paint) 메트릭 추가**: Core Web Vitals 2024+ 지원
  - 사용자 상호작용 응답성 측정
  - 200ms 임계값으로 성능 예산 설정
- **성능 모니터링 강화**: 
  - 실시간 INP 측정 및 로깅
  - 성능 예산에 INP 추가
- **PWA 기능 업데이트**: 최신 PWA API 지원 문서화
- **Sentry 에러 추적 개선**: 2025년 표준에 맞춘 설정 최적화
- **서비스 워커 캐싱 수정**: Vite 빌드 경로 호환성 개선
