...
![TipTap](https://img.shields.io/badge/TipTap-3.30.1-1a1a2e)
...
- **Teaching History** — 44 entries across 5 years (2022–2026), org type filter (4 categories)
...
- **Tests** — Vitest (1230 tests) + Django unittest (357 tests) + Playwright E2E (5 profiles)
