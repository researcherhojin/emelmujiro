...
export const blogPosts: BlogPost[] = [
  {
    ...
    description: '인공지능이 우리의 일상을 어떻게 변화시키고 있는지 알아봅니다.',
...
앞으로 AI는 더욱 정교해지고 인간과 자연스럽게 협업하는 시대가 올 것입니다. 윤리적인 AI 개발과 규제가 중요한 과제가 될 것입니다.`,
  ...
  },
  {
    ...
    description: '초보자를 위한 프로그래밍 학습 가이드',
...
- GitHub (포트폴리오 관리)`,
  ...
  },
  {
    ...
    description: '올해 주목해야 할 웹 개발 기술들',
...
- **Svelte/SvelteKit**: 빠른 성장세`,
  ...
  },
  {
    ...
    description: '주요 프론트엔드 프레임워크 비교 분석',
...
- **적합한 경우**: 엔터프라이즈 앱, 대규모 팀`,
  ...
  },
  {
    ...
    description: '쿠버네티스와 도커를 활용한 현대적인 앱 개발',
    content: `## 클라우드 네이티브란?
...
- 장애 격리`,
  ...
  },
  {
    ...
    description: 'JavaScript 개발자를 위한 TypeScript 입문',
