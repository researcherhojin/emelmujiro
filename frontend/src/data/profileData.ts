...
export const getTeachingHistory = (): TeachingItem[] => [
  // 2026
  {
    organization: i18n.t('teachingHistory.46.org'),
    title: i18n.t('teachingHistory.46.title'),
    year: 2026,
    orgType: 'academic',
  },
  {
    organization: i18n.t('teachingHistory.45.org'),
    title: i18n.t('teachingHistory.45.title'),
    year: 2026,
    orgType: 'moel',
  },
  {
    organization: i18n.t('teachingHistory.44.org'),
    title: i18n.t('teachingHistory.44.title'),
    year: 2026,
    orgType: 'moel',
    visibleAfter: '2026-08-08',
  },
  {
  ...
  },
  {
    ...
    year: 2026,
    orgType: 'academic',
    visibleAfter: '2026-07-08',
  },
  {
    organization: i18n.t('teachingHistory.42.org'),
    title: i18n.t('teachingHistory.42.title'),
    year: 2026,
    orgType: 'academic',
    visibleAfter: '2026-06-23',
  },
  {
  ...
  },
  {
    ...
    year: 2026,
    orgType: 'enterprise',
    visibleAfter: '2026-05-01',
  },
  {
    organization: i18n.t('teachingHistory.40.org'),
