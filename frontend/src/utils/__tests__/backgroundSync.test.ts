...
describe('backgroundSync', () => {
  ...
  describe('isBackgroundSyncSupported', () => {
    it.skip('should return true when both serviceWorker and SyncManager are supported', () => {
    ...
    it.skip('should return false when SyncManager is not supported', () => {
      Object.defineProperty(global, 'window', {
        value: {},
        writable: true,
      });
  ...
  describe('registerBackgroundSync', () => {
    it.skip('should register sync successfully without data', async () => {
    ...
    it.skip('should return false when background sync is not supported', async () => {
      Object.defineProperty(global, 'navigator', {
        value: {},
        writable: true,
      });
    ...
    it.skip('should handle sync registration errors', async () => {
  ...
  describe('SYNC_TAGS', () => {
    it.skip('should have correct sync tag constants', () => {
  ...
  describe('complex scenarios', () => {
    it.skip('should handle multiple sync registrations', async () => {
