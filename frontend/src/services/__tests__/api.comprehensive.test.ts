...
describe('API Service Comprehensive Tests', () => {
  ...
  describe('Base Configuration', () => {
    it('should have correct base URL', () => {
      expect(api.defaults.baseURL).toBe(process.env.REACT_APP_API_URL || 'http://localhost:8000/api');
    });
  ...
  describe('Blog Service', () => {
    it('should fetch all posts', async () => {
      ...
      mock.onGet('/blog-posts/?page=1&page_size=6').reply(200, paginatedResponse);
