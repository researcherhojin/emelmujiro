...
const NotificationPrompt: React.FC<NotificationPromptProps> = ({ 
  ...
  if (showSettings) {
    return (
      <div className={`fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4 ${className}`}>
  ...
  return (
    <div className={`fixed bottom-4 right-4 z-50 bg-white dark:bg-gray-800 rounded-lg shadow-xl 
