            ...
            <nav className="-mb-px flex overflow-x-auto scrollbar-hide">
              <button
                ...
                className={`relative py-4 px-6 sm:px-8 font-semibold text-base sm:text-lg transition-all whitespace-nowrap ${
                  activeTab === 'career' ? 'text-gray-900' : 'text-gray-500 hover:text-gray-700'
                }`}
              >
                경력
                <span
                  className={`absolute -bottom-1 left-4 right-4 h-1 bg-gray-900 transition-all duration-200 ${
              ...
              <button
                ...
                className={`relative py-4 px-6 sm:px-8 font-semibold text-base sm:text-lg transition-all whitespace-nowrap ${
                  activeTab === 'education' ? 'text-gray-900' : 'text-gray-500 hover:text-gray-700'
                }`}
              >
                학력
                <span
                ...
                {careerData.map((item, index) => (
                  <div key={index} className="flex gap-8">
                    ...
                    <div className="flex-grow pb-8 border-b border-gray-100 last:border-0">
                      <h3 className="text-xl font-bold text-gray-900 mb-2">{item.company}</h3>
              ...
              <div className="space-y-6">
                {educationData.map((item, index) => (
                  <div key={index} className="flex gap-8">
                    ...
                    <div className="flex-grow pb-8 border-b border-gray-100 last:border-0">
                      <h3 className="text-xl font-bold text-gray-900 mb-2">{item.school}</h3>
              ...
              <div className="grid gap-6">
                <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-gray-300 transition-all hover:shadow-lg">
                  <div className="flex items-start justify-between mb-4">
                    <h3 className="text-lg font-semibold text-gray-900">대기업 AI 교육 프로그램</h3>
                    <span className="text-base text-gray-600">2022 ~ 현재</span>
                  </div>
                  <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                    삼성전자, LG전자, SK, 현대건설 등 국내 주요 대기업 임직원 대상 맞춤형 AI 교육
                    프로그램 설계 및 운영
                  </p>
                ...
                <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-gray-300 transition-all hover:shadow-lg">
                  <div className="flex items-start justify-between mb-4">
                    <h3 className="text-lg font-semibold text-gray-900">LLM 기반 솔루션 개발</h3>
