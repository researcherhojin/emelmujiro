...
describe('BlogSection Component', () => {
    ...
    describe('Normal State', () => {
        ...
        it('displays section header', () => {
            ...
            expect(screen.getByText('최신 AI 기술 동향과 실제 도입 사례를 공유합니다')).toBeInTheDocument();
        });
    ...
    describe('Error State', () => {
        ...
        it('does not display posts when error occurs', () => {
            renderWithRouter(
                <BlogSection posts={mockPosts} isLoading={false} error="Error occurred" />
            );
    ...
    describe('Edge Cases', () => {
        it('handles non-array posts gracefully', () => {
            renderWithRouter(
                <BlogSection posts={null} isLoading={false} error={null} />
            );
        ...
        it('handles undefined posts', () => {
            renderWithRouter(
                <BlogSection posts={undefined} isLoading={false} error={null} />
            );
        ...
        it('handles posts with missing properties', () => {
            ...
            renderWithRouter(
                <BlogSection posts={incompletePosts} isLoading={false} error={null} />
            );
