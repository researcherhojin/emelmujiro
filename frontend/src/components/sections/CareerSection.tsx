...
const ActivityItem: React.FC<ActivityItemProps> = memo(({ activity, index, getActivityTypeColor }) => (
...
const CareerSection: React.FC = memo(() => {
    ...
    const careerData: CareerData = {
        ...
        '2024': {
            ...
            months: {
                '12월': [
                    { title: '멋쟁이사자처럼&한국과학창의재단 찾아가는 학교 컨설팅', type: '컨설팅', status: '완료' },
        ...
        '2023': {
            ...
            months: {
                ...
                '11월': [
                    { title: '한글과컴퓨터 - 성대, 인하대, 경기대 헬스케어 프로젝트', type: '강의', status: '완료' },
                ...
                '9월': [
                    { title: '한글과컴퓨터 - 논문 기반 영상 처리 딥러닝 모델 설계', type: '강의', status: '완료' },
        ...
        <section id="career" className="py-24 bg-white">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <h2 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl mb-6">경력 상세</h2>
                    <p className="text-xl text-gray-600 leading-relaxed">
                        AI 교육과 비즈니스 개발 분야에서 쌓아온 <strong className="text-gray-900">4년간의 경험</strong>을 
                        연도별로 소개합니다.
                    </p>
                </div>
