...
import { CalendarCheck, BookOpen, Users, Code, LucideIcon } from 'lucide-react';
    ...
    const tracks: Track[] = [
        {
            ...
            highlights: ['Spotfire 데이터 분석 및 시각화', 'Python 기반 머신러닝 기초', '실무 데이터 활용 프로젝트'],
        },
        {
            id: 2,
        ...
        <section id="education" className="py-24 bg-white">
            <div className="max-w-6xl mx-auto px-4">
                ...
                >
                    ...
                    <p className="text-xl text-gray-600">현장에서 바로 활용할 수 있는 실무 중심 교육을 제공합니다</p>
                </motion.div>
