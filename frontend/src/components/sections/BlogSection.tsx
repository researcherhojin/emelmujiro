    ...
    <section className="py-24 bg-white">
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex flex-col items-center justify-center min-h-[300px] space-y-4">
          ...
          <p className="text-gray-500 animate-pulse">{t('blog.loading')}</p>
        </div>
      </div>
    </section>
  );
...
const EmptyState: React.FC = memo(() => {
  ...
  return (
    <div className="bg-gray-50 rounded-xl p-12 border border-gray-100 text-center max-w-2xl mx-auto">
      ...
      <p className="text-lg text-gray-600 mb-2">{t('blog.emptyTitle')}</p>
      <p className="text-gray-500">{t('blog.emptyDescription')}</p>
    </div>
  );
});
            ...
            <>
              ...
              {posts.length > 3 && (
                ...
                >
                  ...
                  >
                    <span>{t('blog.viewAllTrends')}</span>
