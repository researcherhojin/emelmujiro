        ...
        <div className="flex items-start space-x-4">
            ...
            <div>
                ...
                <p className="text-gray-600">
                    ...
                    {cert.score && (
                        <span className="text-gray-700 font-semibold"> • {cert.score}</span>
                    )}
                </p>
            </div>
        </div>
...
const AboutSection: React.FC = memo(() => {
    ...
    const goals: GoalItem[] = [
        ...
        },
        {
            ...
            description: '교육과 멘토링을 통해 더 많은 사람들이 AI 기술을 활용할 수 있도록 돕고 있습니다.',
        },
    ];
            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                >
                    ...
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                        삼성전자, SK, LG 등 다수의 대기업 및 공공기관에서 Deep Learning과 LLM 교육과 연구를 수행하는
                ...
                >
                    ...
                    <p className="text-lg md:text-xl opacity-90 leading-relaxed max-w-4xl mx-auto">
                        복잡한 AI 기술을 누구나 이해할 수 있도록 쉽게 풀어내고, 실제 업무에 바로 적용할 수 있는 실용적인
                        교육을 제공하는 것이 저의 목표입니다. 함께 AI의 무한한 가능성을 탐험해보세요.
                    </p>
                </motion.div>
            </div>
        </section>
