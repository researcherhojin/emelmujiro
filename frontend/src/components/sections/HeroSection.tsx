...
const HeroSection: React.FC = memo(() => {
  ...
  return (
    ...
    >
      <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-8 py-20 sm:py-24 text-center">
        {/* Main Headline */}
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black leading-[1.1] tracking-tight mb-8">
        ...
        {/* Subheadline */}
        <p className="text-lg sm:text-xl text-gray-500 dark:text-gray-400 mb-12 leading-relaxed max-w-2xl mx-auto font-medium break-keep">
        ...
        <Link
          ...
          className="inline-flex items-center justify-center px-10 py-5 text-base sm:text-lg font-bold text-white dark:text-gray-900 bg-gray-900 dark:bg-white hover:bg-gray-800 dark:hover:bg-gray-100 transition-all rounded-2xl"
        >
